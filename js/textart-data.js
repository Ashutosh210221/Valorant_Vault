...
const TEXTART_DATA = [
  ...
  /* ===================== BIG BLOCK ART =====================
     Uses ─ for background, █ for outline, ▒ for inner fill,
     and ░ for shadows. Chat-tested. Style modelled on the working
     piece the user provided (the owl/Mareep at the bottom).
  ====================================================== */

  { id: 'big-mareep',  title: 'Mareep',           category: 'big', tags: ['pokemon', 'mareep', 'sheep'],
    art:
      '───────█▒▒▒█───█▒▒▒█──────\n' +
      '───────█▒▒▒█───█▒▒▒█──────\n' +
      '───────█▒▒▒█████▒▒▒█──────\n' +
  ...
  { id: 'big-smiley',  title: 'Smiley',           category: 'big', tags: ['smile', 'happy'],
    art:
      '─────█████████─────\n' +
      '───██▒▒▒▒▒▒▒▒▒██───\n' +
      '──█▒▒▒▒▒▒▒▒▒▒▒▒▒█──\n' +
  ...
  { id: 'big-spike',   title: 'Spike Bomb',       category: 'big', tags: ['spike', 'bomb'],
    art:
      '─────███████─────\n' +
      '───██▒▒▒▒▒▒▒██───\n' +
      '──█▒▒▒▒███▒▒▒▒█──\n' +
  ...
  { id: 'big-l',       title: 'L Bozo',           category: 'big', tags: ['L', 'trash'],
    art:
      '█▒▒──────────────\n' +
      '█▒▒──────────────\n' +
      '█▒▒──────────────\n' +
  ...
  { id: 'big-w',       title: 'W Win',            category: 'big', tags: ['W', 'win'],
    art:
      '█▒▒──────────────────█▒▒\n' +
      '█▒▒──────────────────█▒▒\n' +
      '█▒▒──────────────────█▒▒\n' +
  ...
  { id: 'big-cat',     title: 'Cat Face',         category: 'big', tags: ['cat', 'animal'],
    art:
      '██▒▒────────────▒▒██\n' +
      '██▒▒██────────██▒▒██\n' +
      '██████▒▒────▒▒██████\n' +
